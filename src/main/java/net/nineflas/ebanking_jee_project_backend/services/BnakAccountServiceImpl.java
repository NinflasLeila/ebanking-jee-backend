package net.nineflas.ebanking_jee_project_backend.services;

import jakarta.transaction.Transactional;
import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import net.nineflas.ebanking_jee_project_backend.dtos.*;
import net.nineflas.ebanking_jee_project_backend.entities.*;
...
import net.nineflas.ebanking_jee_project_backend.exceptions.CustomerNotFoundException;
import net.nineflas.ebanking_jee_project_backend.mappers.BankAccountMapperImpl;
import net.nineflas.ebanking_jee_project_backend.repositories.AccountOperationRepository;
import net.nineflas.ebanking_jee_project_backend.repositories.BankAccountRepository;
import net.nineflas.ebanking_jee_project_backend.repositories.CustomerRepository;
